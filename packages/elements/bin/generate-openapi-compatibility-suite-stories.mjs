...
import { StoryComponent, getStoryArgs, OpenapiCompatibilitySuiteStoryArgs } from '@netcracker/qubership-apihub-apispec-view/web-components/__stories__/helpers/compatibility-suite-utils'
